...
ponuda:
  ...
  kartice:
    - naslov: "Ture uskoro stižu"
      ...
      cta: "Pogledaj najavu"
      href: "/ture/"
      image: "~/assets/destinacije/peking/ture-kartica.png"
      imageAlt: "Posetioci ulaze u tradicionalni kompleks Zabranjenog grada u Pekingu"
      size: "wide"

    - naslov: "Destinacije"
      nadnaslov: "ISTRAŽI KINU"
      opis: "Od užurbanih metropola do tropskog Hainana, svaka destinacija otkriva drugačije lice Kine. Saznaj šta vredi videti, kada putovati i koliko dana izdvojiti."
      cta: "Istraži destinacije"
      href: "/destinacije/"
      image: "~/assets/destinacije/hainan/destinacije1.jpg"
      imageAlt: "Kruzer ispred modernih zgrada na ostrvu Hainan"
      size: "tall"
    ...
    - naslov: "Blog o Kini"
      ...
      opis: "Korisne informacije o kulturi, običajima, destinacijama i svakodnevnom životu u Kini."
      cta: "Istraži blog"
      href: "/blog/"
      image: "~/assets/kina-zastava.jpg"
      imageAlt: "Kineska zastava na jarbolu pod vedrim nebom"
      size: "normal"
...
prednosti:
  ...
  stavke:
    - naslov: "Poverenje kroz edukaciju"
      opis: "Govorim kineski jezik, poznajem kulturu, lokalnu kuhinju i znam gde vredi izaći iz turističke zone."
      ikonica: "compass"
...
oMeni:
  ...
  kredibilitet:
    ...
    - naslov: "Iskustvo u prevođenju"
      opis: "Direktan rad sa Kinezima i iskustvo u direktnoj međukulturnoj komunikaciji."
      ikonica: "messages"
...
ctaBaner:
  ...
  backgroundImage: "~/assets/kina-sada.jpg"
  backgroundAlt: "Figura kineskog zmaja na krovu tradicionalne građevine"
  primarniCta:
    label: "Pogledaj ture"
    href: "/ture/"
  sekundarniCta:
